...
<%
	if(login_user != null && login_user.uuid_ == circle.circle_leader_id_) out.println("<p><a href=\"circle_admin.jsp?id=" + circle.id_ + "\">サークル情報を変更する</a>　｜　<a href=\"#\">サークルメンバーを招待する</a>　｜　<a href=\"#\">Twitterで広報する</a></p>");
%>
				</div>
				<div class="box4-1-1">
					<%
